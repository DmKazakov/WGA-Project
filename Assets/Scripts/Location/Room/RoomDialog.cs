...
public class RoomDialog : MonoBehaviour
{
    ...
    private void FirstDialog()
    {
        ...
        txtNPC[12] = "И возьми с собой САОП - 2 (Самоходный Аппарат Обеспечения Порядка), он защитит тебя от проблем.";
    }
    ...
    private void SisterDialog()
    {
        ...
        txtPlayer[1] = "Ты знаешь, где я могу найти других андроидов?";

        txtNPC = new string[3];
        txtNPC[0] = "Голова раскалывается… Что произошло?";
        txtNPC[1] = "Спасибо тебе, сестричка. Немного нас осталось. Как я могу тебе помочь?";
